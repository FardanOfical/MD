...
case 'donasi': case 'donate': {
                hisoka.sendMessage(m.chat, { image: { url: 'https://wa.me/6288973682588' }, caption: `Silahkan Scan Kode QR Diatas Untuk Donasi` }, { quoted: m })
            }
            break
case 'gopay': {
                hisoka.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/d0b1f2f2d5c4875577b6a.jpg' }, caption: `GOPAY` }, { quoted: m })
            }
            break
case 'dana': {
                hisoka.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/64be0f3976bfd2935570e.jpg' }, caption: `DANA` }, { quoted: m })
            }
            break
case 'qris': {
                hisoka.sendMessage(m.chat, { image: { url: 'https://telegra.ph/Donate-Gopay-07-16' }, caption: `QRIS ALL PAYMENT` }, { quoted: m })
            }
            break
...
╰──── 
╭─[ *MINAT CHAT📌*]
│❏ ➪ 🪀 _wa.me/6288973682588?text=SEWA+BOT_
╰────
╭─[ *PAYMENT💰*]
│❏ ➪ _GOPAY_
│❏ ➪ _DANA_
...
—————「 *SEWA | BOT* 」—————
  ...
  *JADI BOT* 
  *≻* Jadi Bot + Owner 28k (Permanen)

  *JASA RUN BOT*
  *≻* Run Bot + Jadi Bot 32k (Permanen)
